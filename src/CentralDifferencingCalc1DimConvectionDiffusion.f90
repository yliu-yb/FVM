...
!> the module achieve Central differencing scheme
!!
!! @author Yan Liu
!! @date August,19,2022

module CentralDifferencingCalc1DimConvectionDiffusion
    implicit none
    
contains
function CentralDiffCalc1DimConvectionDiffusion(para) result(mk)
    ! Function for one-dimensional steady convection-diffusion case
        ...
        mk = 1
    end function CentralDiffCalc1DimConvectionDiffusion    
end module CentralDifferencingCalc1DimConvectionDiffusion
