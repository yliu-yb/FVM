module HybridDifferencingCalc1DimConvectionDiffusion
    implicit none
    
contains
function HybirdDiffCalc1DimConvectionDiffusion(para) result(mk)
    ! Function for one-dimensional steady convection-diffusion case
        ...
        mk = 1
    end function HybirdDiffCalc1DimConvectionDiffusion
    
end module HybridDifferencingCalc1DimConvectionDiffusion